# Autogenerated wrapper script for Poppler_jll for x86_64-w64-mingw32-cxx11
...
const pdfattach_splitpath = ["bin", "pdfattach.exe"]
...
const pdfimages_splitpath = ["bin", "pdfimages.exe"]
...
const pdfunite_splitpath = ["bin", "pdfunite.exe"]
...
const pdftoppm_splitpath = ["bin", "pdftoppm.exe"]
...
const pdfinfo_splitpath = ["bin", "pdfinfo.exe"]
...
const pdftohtml_splitpath = ["bin", "pdftohtml.exe"]
...
const libpoppler_splitpath = ["bin", "libpoppler-98.dll"]
...
const libpoppler = "libpoppler-98.dll"


# Relative path to `libpoppler_cpp`
const libpoppler_cpp_splitpath = ["bin", "libpoppler-cpp-0.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libpoppler_cpp = "libpoppler-cpp-0.dll"


# Relative path to `pdffonts`
const pdffonts_splitpath = ["bin", "pdffonts.exe"]
...
const pdfseparate_splitpath = ["bin", "pdfseparate.exe"]
...
const pdftocairo_splitpath = ["bin", "pdftocairo.exe"]
...
const pdftotext_splitpath = ["bin", "pdftotext.exe"]
...
const pdftops_splitpath = ["bin", "pdftops.exe"]
...
const pdfdetach_splitpath = ["bin", "pdfdetach.exe"]
