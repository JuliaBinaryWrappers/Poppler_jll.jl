# Autogenerated wrapper script for Poppler_jll for x86_64-apple-darwin14-cxx11
...
const libpoppler_splitpath = ["lib", "libpoppler.98.0.0.dylib"]
...
const libpoppler = "@rpath/libpoppler.98.dylib"


# Relative path to `libpoppler_cpp`
const libpoppler_cpp_splitpath = ["lib", "libpoppler-cpp.0.7.0.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libpoppler_cpp = "@rpath/libpoppler-cpp.0.dylib"
