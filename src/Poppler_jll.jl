...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Poppler_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("9c32591e-4766-534b-9725-b71a8799265b"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Poppler", artifacts_toml) for e in artifacts["Poppler"]]
...
if best_platform === nothing
    @debug("Unable to load Poppler; unsupported platform $(triplet(platform_key_abi()))")
else
